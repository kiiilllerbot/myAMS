...
class RegistersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post registers_url, params: { register: { description: @register.description, semester: @register.semester, student_id: @register.student_id, user_id: @register.user_id } }
    end
  ...
  test "should update register" do
    patch register_url(@register), params: { register: { description: @register.description, semester: @register.semester, student_id: @register.student_id, user_id: @register.user_id } }
